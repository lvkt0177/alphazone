...
function tinhLai() {
    ...
    const tongThuNhap = layGiaTri('pl_tong_thu_nhap');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    attachMoneyFormatter('pl_tong_thu_nhap_display', 'pl_tong_thu_nhap');
    ...
    ['pl_tong_thu_nhap_display', 'pl_tong_khau_tru_display', 'pl_cong_tac_phi_display',
        'pl_tam_ung_display', 'pl_giam_tru_display'].forEach(function (id) {
