...
<head>
    ...
    <title>Phiên đăng nhập đã hết hạn - AlphaZone</title>
    ...
    <div class="login-wrap">
        <div class="login-card" style="text-align:center;">
            <div
                ...
                <i class="ri-refresh-line" style="font-size:30px;color:var(--orange);"></i>
            </div>
            <div class="login-title">Phiên làm việc đã hết hạn</div>
            <div class="login-sub" style="margin-bottom:22px;">
                Trang đăng nhập đã mở quá lâu hoặc phiên của bạn không còn hợp lệ.
