            ...
            <div class="modal-body">
                <div class="form-grid">
                    ...
                    <div class="field">
                        ...
                        <input id="tu_fee" type="text" inputmode="numeric" autocomplete="off" placeholder="VD: 500,000">
                        @error('hoc_phi')
                    ...
                    <div class="field">
                        ...
                        <input id="tu_uniform" type="text" inputmode="numeric" autocomplete="off" placeholder="VD: 150,000">
                    </div>
